    ...
    const newArray = TilesDetails.map(item => {
        return (
            <>
                ...
                <div id="tags" className="mt-5 mb-2 ml-8 flex flex-wrap "><a href="/search/Chatbot"
                    className="mx-1 mb-1 text-xs inline-flex items-center font-bold leading-sm uppercase px-3 py-1 bg-secondary text-primary rounded-full">Chatbot
                </a><a href="/search/GPT-3"
                    className="mx-1 mb-1 text-xs inline-flex items-center font-bold leading-sm uppercase px-3 py-1 bg-secondary text-primary rounded-full">GPT-3
                    </a><a href="/search/OpenAI"
                        className="mx-1 mb-1 text-xs inline-flex items-center font-bold leading-sm uppercase px-3 py-1 bg-secondary text-primary rounded-full">OpenAI
                    </a><a href="/search/Free"
                        className="mx-1 mb-1 text-xs inline-flex items-center font-bold leading-sm uppercase px-3 py-1 bg-secondary text-primary rounded-full">Free
                    </a><a href="/search/Text Generation"
                        className="mx-1 mb-1 text-xs inline-flex items-center font-bold leading-sm uppercase px-3 py-1 bg-secondary text-primary rounded-full">Text
                        Generation
                    </a>
                </div>
            </div >
